      ...
      <div className="container max-w-screen-xl mx-auto px-4 text-center">
        ...
        <div className="flex flex-col lg:flex-row justify-between">
          <div className="space-y-8 md:space-y-16 mb-16 md:mb-0">
            <h6 className="font-medium text-base uppercase">Company</h6>
          ...
          <div className="space-y-8 md:space-y-16 mb-16 md:mb-0">
            <h6 className="font-medium text-base uppercase">Position</h6>
            <p className="font-normal text-gray-400 text-base">
              Junior Full Stack Developer
            </p>
          </div>
          <div className="space-y-8 md:space-y-16">
            <h6 className="font-medium text-base uppercase">Year</h6>
            <p className="font-normal text-gray-400 text-base">
              Aug, 2023 - Jan, 2024
            </p>
          </div>
