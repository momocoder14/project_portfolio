  ...
  return (
    <div className="relative max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
      <blockquote className="text-center lg:mx-auto lg:w-3/5">
        <img
          src="https://cmkt-image-prd.freetls.fastly.net/0.1.0/ps/6713806/3500/2330/m1/fpnw/wm0/logos-21-77-.jpg?1563702063&s=c25446499054f94d550e28c39b63e932"
          alt=""
          className='size-40 mx-auto rounded-full'
        />
        ...
        <div className="mt-6 lg:mt-10">
          <p className="relative text-xl sm:text-2xl md:text-3xl md:leading-normal font-medium text-gray-800">
            ...
            <span className="relative z-10 italic text-gray-800 dark:text-neutral-200">
              Momocoder is one of the est developers I have ever met. I highly recommend him to everyone out there.
            </span>
          </p>
        </div>
        <div className="image-container py-3">
          <img src={profile} alt="" className='mx-auto w-1/5'/>
        </div>
